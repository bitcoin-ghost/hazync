...
SMT plus audit #3, and by `b161735a…` in v0.16.0 when #88 removed the repo checkout path from the id —
see `reproduce/METHOD_ID` for the full chain). A leaf preimage is
