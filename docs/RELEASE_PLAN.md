...
⏰ **That cutover has NOT happened yet.** The live coordinator still serves `3867611d…` with 1,586
blocks proven against it. The release, the coordinator swap, the wasm deploy and the board reset are
