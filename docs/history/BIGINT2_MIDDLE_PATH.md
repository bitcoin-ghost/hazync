...
> **Historical record, moved here on 2026-09-14.** The #139 middle path (`patches/0005`) is a
> **Ghost-channel lever only and never shipped in CORE**; the canonical guest since v0.21.0 applies
> `0001`/`0002`/`0012`/`0013` — see `../BUILDS.md`. The trial harness, formerly
> `EXPERIMENT_139_BIGINT2.md`, is merged below.
...
*(2026-09-14: 2.45x was a projection, first written on `archive/perf-bigint2-middle-path` before any
proving run. Measured on block 962,000 without the armed packer the straggler was **2.118** — arm S in
`GHOST_GAINS.md` §0.)*
...
## Development record — the #139 trial harness (formerly `EXPERIMENT_139_BIGINT2.md`)
...
*(2026-09-14: the wholesale row is void — see the correction at the top of this section; `9b767b5`
records that `hazync_ecdsa_verify_full` had no call site until `patches/0014`.)*
...
*(2026-09-14: void — no run produced this; see the correction at the top of this section.)*
...
*(2026-09-14: superseded — this table predates the results above. Digest match and cycle win were
measured on 2026-08-28, the GPU prove measured 8.00x the same day, and exhaustive equivalence never
started because the middle path did not ship in CORE.)*
