...
(`4722cec8…`, the current guest) for **both** the CPU and CUDA release binaries.
...
Both published binaries must print the canonical `METHOD_ID` (`4722cec8…`); the guest id is reproducible,
