...
check(isinstance(code, str) and "gave up after one retry" in code and "segment 2/2" in code,
      f"hangs after 2 segments -> killed, then a loud failure naming how far it got ({str(code)[:90]!r})")
